...
import heroImage from "../../assets/hero-doctor-image.png"
        ...
        <section className={styles.hero}>
            <div className={styles["hero-content-container"]}>
                <div className={styles["hero-content"]}>
                        <h1 className={styles["hero-title"]}>Expert Medical Services for a <span className={styles["highlight-title"]}>Healthier</span> Future</h1>
